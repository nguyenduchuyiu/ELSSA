...
from CoquiTTS.tts.configs.glow_tts_config import GlowTTSConfig
from CoquiTTS.tts.layers.glow_tts.decoder import Decoder
from CoquiTTS.tts.layers.glow_tts.encoder import Encoder
...
class GlowTTS(BaseTTS):
    ...
    @staticmethod
    def get_criterion():
        from CoquiTTS.tts.layers.losses import GlowTTSLoss  # pylint: disable=import-outside-toplevel
