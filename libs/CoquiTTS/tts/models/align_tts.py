...
from CoquiTTS.tts.layers.align_tts.mdn import MDNBlock
from CoquiTTS.tts.layers.feed_forward.decoder import Decoder
from CoquiTTS.tts.layers.feed_forward.duration_predictor import DurationPredictor
...
from CoquiTTS.tts.utils.helpers import generate_path, maximum_path, sequence_mask
from CoquiTTS.tts.utils.speakers import SpeakerManager
from CoquiTTS.tts.utils.text.tokenizer import TTSTokenizer
from CoquiTTS.tts.utils.visual import plot_alignment, plot_spectrogram
...
class AlignTTS(BaseTTS):
    ...
    def get_criterion(self):
        from CoquiTTS.tts.layers.losses import AlignTTSLoss  # pylint: disable=import-outside-toplevel
