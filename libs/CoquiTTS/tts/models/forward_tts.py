...
from CoquiTTS.tts.layers.feed_forward.decoder import Decoder
from CoquiTTS.tts.layers.feed_forward.encoder import Encoder
from CoquiTTS.tts.layers.generic.aligner import AlignmentNetwork
from CoquiTTS.tts.layers.generic.pos_encoding import PositionalEncoding
...
from CoquiTTS.tts.utils.helpers import average_over_durations, generate_path, maximum_path, sequence_mask
from CoquiTTS.tts.utils.speakers import SpeakerManager
from CoquiTTS.tts.utils.text.tokenizer import TTSTokenizer
from CoquiTTS.tts.utils.visual import plot_alignment, plot_avg_energy, plot_avg_pitch, plot_spectrogram
...
class ForwardTTS(BaseTTS):
    ...
    def get_criterion(self):
        from CoquiTTS.tts.layers.losses import ForwardTTSLoss  # pylint: disable=import-outside-toplevel
