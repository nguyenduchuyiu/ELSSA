...
from CoquiTTS.tts.configs.shared_configs import CharactersConfig
from CoquiTTS.tts.datasets.dataset import TTSDataset, _parse_sample
from CoquiTTS.tts.layers.glow_tts.duration_predictor import DurationPredictor
from CoquiTTS.tts.layers.vits.discriminator import VitsDiscriminator
from CoquiTTS.tts.layers.vits.networks import PosteriorEncoder, ResidualCouplingBlocks, TextEncoder
from CoquiTTS.tts.layers.vits.stochastic_duration_predictor import StochasticDurationPredictor
from CoquiTTS.tts.models.base_tts import BaseTTS
from CoquiTTS.tts.utils.fairseq import rehash_fairseq_vits_checkpoint
from CoquiTTS.tts.utils.helpers import generate_path, maximum_path, rand_segments, segment, sequence_mask
from CoquiTTS.tts.utils.languages import LanguageManager
from CoquiTTS.tts.utils.speakers import SpeakerManager
from CoquiTTS.tts.utils.synthesis import synthesis
from CoquiTTS.tts.utils.text.characters import BaseCharacters, BaseVocabulary, _characters, _pad, _phonemes, _punctuations
from CoquiTTS.tts.utils.text.tokenizer import TTSTokenizer
from CoquiTTS.tts.utils.visual import plot_alignment
from CoquiTTS.utils.io import load_fsspec
from CoquiTTS.utils.samplers import BucketBatchSampler
from CoquiTTS.vocoder.models.hifigan_generator import HifiganGenerator
from CoquiTTS.vocoder.utils.generic_utils import plot_results
...
class Vits(BaseTTS):
    ...
    def get_criterion(self):
        ...
        `train_step()`"""
        from CoquiTTS.tts.layers.losses import (  # pylint: disable=import-outside-toplevel
    ...
    def load_fairseq_checkpoint(
        ...
        from CoquiTTS.tts.utils.text.cleaners import basic_cleaners
    ...
    def init_from_config(config: "VitsConfig", samples: Union[List[List], List[Dict]] = None, verbose=True):
        ...
        Args:
            ...
            samples (Union[List[List], List[Dict]]): Training samples to parse speaker ids for training.
                Defaults to None.
        """
        from CoquiTTS.utils.audio import AudioProcessor
