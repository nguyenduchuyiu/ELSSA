...
class BaseSpeakerTTS(OpenVoiceBaseClass):
    ...
    def tts(self, text, output_path=None, speaker='default', language='English', speed=1.0):
...
class ToneColorConverter(OpenVoiceBaseClass):
    ...
    def convert(self, raw_audio, src_se, tgt_se, audio_src_path=None, output_path=None, tau=0.3, message="default"):
        hps = self.hps
        if audio_src_path is not None:
            ...
            audio = torch.tensor(raw_audio).float()
